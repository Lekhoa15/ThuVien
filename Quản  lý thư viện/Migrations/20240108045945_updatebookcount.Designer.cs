...
namespace Quản__lý_thư_viện.Migrations
{
    ...
    [Migration("20240108045945_updatebookcount")]
    partial class updatebookcount
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Quản__lý_thư_viện.AppModel.PhieuMuon", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            MaPhieuMuon = 1,
                            MaDocGia = 3,
                            NgayMuon = new DateTime(2024, 1, 8, 11, 59, 45, 201, DateTimeKind.Local).AddTicks(3685)
                        });
                });
            ...
            modelBuilder.Entity("Quản__lý_thư_viện.AppModel.User", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("Quản__lý_thư_viện.AppModel.sach", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            dem = 0,
                            namXuatBan = 2023,
                            ngayNhap = new DateTime(2024, 1, 8, 11, 59, 45, 201, DateTimeKind.Local).AddTicks(3564),
                            tacgia = "Van Hoang"
                        },
                        new
                        {
                            ...
                            dem = 0,
                            namXuatBan = 2023,
                            ngayNhap = new DateTime(2024, 1, 8, 11, 59, 45, 201, DateTimeKind.Local).AddTicks(3578),
                            tacgia = "Van Hoang"
                        },
                        new
                        {
                            ...
                            dem = 0,
                            namXuatBan = 2023,
                            ngayNhap = new DateTime(2024, 1, 8, 11, 59, 45, 201, DateTimeKind.Local).AddTicks(3580),
                            tacgia = "Van Hoang"
                        });
                });
