...
namespace Quản__lý_thư_viện.Migrations
{
    ...
    [Migration("20240103025659_updatePhieuMuontrangthai")]
    partial class updatePhieuMuontrangthai
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Quản__lý_thư_viện.AppModel.PhieuMuon", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            MaPhieuMuon = 1,
                            MaDocGia = 3,
                            NgayMuon = new DateTime(2024, 1, 3, 9, 56, 59, 810, DateTimeKind.Local).AddTicks(9910)
                        });
                });
            ...
            modelBuilder.Entity("Quản__lý_thư_viện.AppModel.sach", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            namXuatBan = 2023,
                            ngayNhap = new DateTime(2024, 1, 3, 9, 56, 59, 810, DateTimeKind.Local).AddTicks(9793),
                            tacgia = "Van Hoang"
                        },
                        new
                        {
                            ...
                            namXuatBan = 2023,
                            ngayNhap = new DateTime(2024, 1, 3, 9, 56, 59, 810, DateTimeKind.Local).AddTicks(9807),
                            tacgia = "Van Hoang"
                        },
                        new
                        {
                            ...
                            namXuatBan = 2023,
                            ngayNhap = new DateTime(2024, 1, 3, 9, 56, 59, 810, DateTimeKind.Local).AddTicks(9808),
                            tacgia = "Van Hoang"
                        });
                });
