...
namespace Quản__lý_thư_viện.Migrations
{
    ...
    [Migration("20240103031853_updatePhieuTra1")]
    partial class updatePhieuTra1
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Quản__lý_thư_viện.AppModel.PhieuMuon", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            MaPhieuMuon = 1,
                            MaDocGia = 3,
                            NgayMuon = new DateTime(2024, 1, 3, 10, 18, 53, 880, DateTimeKind.Local).AddTicks(4851)
                        });
                });
            ...
            modelBuilder.Entity("Quản__lý_thư_viện.AppModel.sach", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            namXuatBan = 2023,
                            ngayNhap = new DateTime(2024, 1, 3, 10, 18, 53, 880, DateTimeKind.Local).AddTicks(4735),
                            tacgia = "Van Hoang"
                        },
                        new
                        {
                            ...
                            namXuatBan = 2023,
                            ngayNhap = new DateTime(2024, 1, 3, 10, 18, 53, 880, DateTimeKind.Local).AddTicks(4749),
                            tacgia = "Van Hoang"
                        },
                        new
                        {
                            ...
                            namXuatBan = 2023,
                            ngayNhap = new DateTime(2024, 1, 3, 10, 18, 53, 880, DateTimeKind.Local).AddTicks(4750),
                            tacgia = "Van Hoang"
                        });
                });
