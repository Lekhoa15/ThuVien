...
namespace Quản__lý_thư_viện.Migrations
{
    ...
    [Migration("20240103032500_updatePhieuTra2")]
    partial class updatePhieuTra2
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Quản__lý_thư_viện.AppModel.PhieuMuon", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            MaPhieuMuon = 1,
                            MaDocGia = 3,
                            NgayMuon = new DateTime(2024, 1, 3, 10, 25, 0, 232, DateTimeKind.Local).AddTicks(2569)
                        });
                });
            ...
            modelBuilder.Entity("Quản__lý_thư_viện.AppModel.sach", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            namXuatBan = 2023,
                            ngayNhap = new DateTime(2024, 1, 3, 10, 25, 0, 232, DateTimeKind.Local).AddTicks(2441),
                            tacgia = "Van Hoang"
                        },
                        new
                        {
                            ...
                            namXuatBan = 2023,
                            ngayNhap = new DateTime(2024, 1, 3, 10, 25, 0, 232, DateTimeKind.Local).AddTicks(2461),
                            tacgia = "Van Hoang"
                        },
                        new
                        {
                            ...
                            namXuatBan = 2023,
                            ngayNhap = new DateTime(2024, 1, 3, 10, 25, 0, 232, DateTimeKind.Local).AddTicks(2463),
                            tacgia = "Van Hoang"
                        });
                });
