...
namespace Quản__lý_thư_viện.Migrations
{
    ...
    [Migration("20240103031800_updatePhieuTra")]
    partial class updatePhieuTra
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Quản__lý_thư_viện.AppModel.PhieuMuon", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            MaPhieuMuon = 1,
                            MaDocGia = 3,
                            NgayMuon = new DateTime(2024, 1, 3, 10, 18, 0, 481, DateTimeKind.Local).AddTicks(4939)
                        });
                });
            ...
            modelBuilder.Entity("Quản__lý_thư_viện.AppModel.sach", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            namXuatBan = 2023,
                            ngayNhap = new DateTime(2024, 1, 3, 10, 18, 0, 481, DateTimeKind.Local).AddTicks(4828),
                            tacgia = "Van Hoang"
                        },
                        new
                        {
                            ...
                            namXuatBan = 2023,
                            ngayNhap = new DateTime(2024, 1, 3, 10, 18, 0, 481, DateTimeKind.Local).AddTicks(4840),
                            tacgia = "Van Hoang"
                        },
                        new
                        {
                            ...
                            namXuatBan = 2023,
                            ngayNhap = new DateTime(2024, 1, 3, 10, 18, 0, 481, DateTimeKind.Local).AddTicks(4842),
                            tacgia = "Van Hoang"
                        });
                });
