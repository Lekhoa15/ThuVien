...
namespace Quản__lý_thư_viện.Migrations
{
    ...
    [Migration("20240104093058_users")]
    partial class users
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Quản__lý_thư_viện.AppModel.PhieuMuon", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            MaPhieuMuon = 1,
                            MaDocGia = 3,
                            NgayMuon = new DateTime(2024, 1, 4, 16, 30, 58, 345, DateTimeKind.Local).AddTicks(1012)
                        });
                });
            ...
            modelBuilder.Entity("Quản__lý_thư_viện.AppModel.sach", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            namXuatBan = 2023,
                            ngayNhap = new DateTime(2024, 1, 4, 16, 30, 58, 345, DateTimeKind.Local).AddTicks(882),
                            tacgia = "Van Hoang"
                        },
                        new
                        {
                            ...
                            namXuatBan = 2023,
                            ngayNhap = new DateTime(2024, 1, 4, 16, 30, 58, 345, DateTimeKind.Local).AddTicks(901),
                            tacgia = "Van Hoang"
                        },
                        new
                        {
                            ...
                            namXuatBan = 2023,
                            ngayNhap = new DateTime(2024, 1, 4, 16, 30, 58, 345, DateTimeKind.Local).AddTicks(903),
                            tacgia = "Van Hoang"
                        });
                });
